    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-white tracking-tight">Movimientos financieros</h1>
                    <p className="text-zinc-400 mt-1">Historial completo de ventas, pagos, cuotas y compras.</p>
                </div>
